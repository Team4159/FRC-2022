...
public class AutoSelector {
   ...
   // Auto
    ...
    public AutoSelector(Drivetrain drivetrain, Arm arm, Intake intake, Feeder feeder, Neck neck, Shooter shooter) {
        ...
        redAuto3 = new BlueAuto3(drivetrain, arm, intake, feeder, neck, shooter);
        ...
        blueAuto3 = new RedAuto3(drivetrain, arm, intake, feeder, neck, shooter);
