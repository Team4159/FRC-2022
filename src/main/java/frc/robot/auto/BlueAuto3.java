...
//Does Nothing
public class BlueAuto3 extends ParallelCommandGroup{
    ...
    public BlueAuto3(Drivetrain drivetrain, Arm arm, Intake intake, Feeder feeder, Shooter shooter, Neck neck) {
